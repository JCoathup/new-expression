...
document.addEventListener("click", function(e){
  ...
  if (e.target && e.target.id == "share"){
    ...
    _shareList.innerHTML += `<li><button class='share icofont icofont-download menuItems' title="download" id="download" style='font-size:84px; color: #fff; background-color: #e6d068;'></button></li>
                            ...
                            <li><a href="https://twitter.com/intent/tweet?text=Hello%20world" target="_blank"><button class='share icofont icofont-social-twitter menuItems' id='tweet' style='font-size:84px; color:#fff; background-color: #0084B4;'></button></a></li>
