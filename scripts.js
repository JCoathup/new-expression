...
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;
context.drawImage(img, 0, 0, tempCanvas.width, tempCanvas.height, tempCanvas.width - img.width, tempCanvas.height - img.height, canvas.width/tempCanvas.width, canvas.width/tempCanvas.height);
