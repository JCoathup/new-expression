...
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;
context.drawImage(img, 0, 0, tempCanvas.width, tempCanvas.height, img.width - tempCanvas.width, img.height - tempCanvas.height, canvas.width/tempCanvas.width, canvas.width/tempCanvas.height);
